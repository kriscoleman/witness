import { CallToAction } from '@testifysec/wings'
...
### What's Next?
<CallToAction 
  bgImage={{ src: "https://i.imgur.com/uU7hf1n.jpeg" }} 
  actionImage={{ src: "https://raw.githubusercontent.com/in-toto/witness/main/docs/assets/logo.png", alt: "Witty the Witness Mascot"}} 
  actionImageClassName="w-36" 
  title="Witness Policy" 
  subtitle="If you enjoyed this intro to Witness, you might benefit from taking things a step further by learning about Witness Policies" 
  primaryButton={{ label: "Let's Go!", link: "./artifact-policy"}} 
  />